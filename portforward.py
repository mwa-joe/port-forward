...
def open_port(service_url,external_port,internal_client,internal_port=None,protocol='TCP',duration=0,description=None,enabled=True):
    ...
    if description == None:
        description = 'generated by portforward.py'
    ...
    arguments = [
        ...
        ('NewEnabled', int(enabled)),                    # turn mapping ON
    ...
    conn.request('POST',
        parsedurl.path,
        pure_xml,
        {'SOAPAction': '"urn:schemas-upnp-org:service:WANIPConnection:1#{}"'.format(action),
